            ...
            modelBuilder.Entity("Galatea.Data.Models.Publication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ddeab18-e375-491a-aa27-362618e3e7bd"),
                            CategoryId = 2,
                            Content = "Квартален магазин за хранителни стоки търси персонал. За повече информация - 0888888888",
                            CreatedOn = new DateTime(2023, 8, 10, 10, 40, 25, 411, DateTimeKind.Local).AddTicks(9341),
