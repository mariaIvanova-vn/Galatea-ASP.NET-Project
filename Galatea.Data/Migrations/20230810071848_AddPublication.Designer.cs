...
namespace Galatea.Data.Migrations
{
    ...
    [Migration("20230810071848_AddPublication")]
            ...
            modelBuilder.Entity("Galatea.Data.Models.Publication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3fccdf54-22c5-47f2-ab6a-fc987d16d704"),
                            CategoryId = 2,
                            Content = "Квартален магазин за хранителни стоки търси персонал. За повече информация - 0888888888",
                            CreatedOn = new DateTime(2023, 8, 10, 10, 18, 47, 924, DateTimeKind.Local).AddTicks(1588),
