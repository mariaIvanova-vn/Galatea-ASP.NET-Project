...
namespace Galatea.Data.Migrations
{
    ...
    [Migration("20230810100128_comments")]
            ...
            modelBuilder.Entity("Galatea.Data.Models.Publication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dff5f044-7a8b-4ba6-b197-ff5bfc4cb4c5"),
                            CategoryId = 2,
                            Content = "Квартален магазин за хранителни стоки търси персонал. За повече информация - 0888888888",
                            CreatedOn = new DateTime(2023, 8, 10, 13, 1, 27, 816, DateTimeKind.Local).AddTicks(1106),
